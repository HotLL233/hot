...
# -*- coding: utf-8 -*-
"""
检测数据统计工具 v2.2.6 - 在线更新版
-----------------------------------
新增 (v2.2.5 → v2.2.6)：
1. 在线更新：基于 GitHub Releases 检查新版本
2. 一键下载安装包并静默升级
3. 侧边栏新增"检查更新"按钮
"""
...
# Version: 2.2.6
# 更新说明：
# - 新增 check_update / download_update API，对接 GitHub Releases
# - 更新入口整合到"关于"弹窗内，点击"检查更新"显示结果
# - 更新流程：检查→下载→静默安装（Inno Setup /VERYSILENT）
