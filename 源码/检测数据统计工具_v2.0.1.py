...
# Version: 2.0.1
# 更新说明：
# - 整体框架从 Tkinter 迁移到 pywebview (Web UI)
# - 去除所有渐变效果，使用纯色按钮
# - 添加应用图标，支持暗色/浅色主题自适应
# - 暗色/浅色双主题切换
# - 保留所有核心数据处理逻辑
...
class BackendApi:
    ...
    def _df_to_table_json(self, results: pd.DataFrame, total_series: pd.Series,
        ...
        """将 DataFrame 转换为前端表格需要的 JSON 结构"""
        if results.empty:
